...
from utils.app_config import FreedomAppConfig
...
SECRET_KEY = FreedomAppConfig.secret_key
...
DATABASES = {
    'default': {
        ...
        'HOST': FreedomAppConfig.mysql_host, 
        'USER': FreedomAppConfig.mysql_user,
        'PASSWORD': FreedomAppConfig.mysql_password,
        'NAME': FreedomAppConfig.mysql_database,
        'PORT': FreedomAppConfig.mysql_port, 
        'OPTIONS': {
            'charset': 'utf8mb4',
        },
    }
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '10/minute',  # Anonymous users can attempt login 10 times per minute
